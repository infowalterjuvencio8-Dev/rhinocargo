                ...
                <div className="flex justify-between items-start border-b border-slate-800 pb-4 mb-4 print:bg-[#F0F2FA] print:p-4 print:rounded-lg print:border-b-2 print:border-[#283B91] print:text-slate-900">
                  <div className="flex items-start gap-4">
                    <div className="w-20 h-10 max-h-10 flex items-center justify-center overflow-hidden shrink-0">
                      <img src={logoImg} className="max-w-full max-h-full object-contain" alt="RHINO CARGO" />
                    </div>
                    <div className="space-y-0.5">
                      <span className="text-sm font-black text-white print:text-[#283B91] uppercase tracking-wider">RHINO CARGO LDA</span>
                      <p className="text-[10px] font-bold text-[#EA088C]">Força | Flexibilidade | Movimento</p>
                      <p className="text-[9px] font-semibold text-[#38B44A]">Empresa Moçambicana</p>
                      <div className="text-[8px] text-slate-400 print:text-slate-600 space-y-0.5 mt-1">
                  ...
                  <div className="text-right space-y-1 shrink-0">
                    <div className="text-[10px] font-bold text-white print:text-[#283B91] uppercase tracking-wider">Ficha de Registo</div>
