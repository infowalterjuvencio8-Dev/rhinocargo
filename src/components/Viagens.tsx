          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 overflow-y-auto">
            ...
            >
              ...
              <div className="p-8 space-y-6 bg-slate-950 text-slate-100 max-h-[75vh] overflow-y-auto print-card print:bg-white print:text-slate-900" id="printable-trip-receipt">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start gap-4 border-b border-slate-800 pb-5 print:bg-[#FAF8EB] print:p-4 print:rounded-lg print:border-b-2 print:border-[#283B91] print:text-slate-900">
