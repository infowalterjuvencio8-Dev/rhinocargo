...
<<<<<<< HEAD
                <div class="stat-value" style="color: #283B91;">${totalFaturado.toLocaleString("pt-MZ")} MZN</div>
=======
...
<<<<<<< HEAD
              <div class="stat-card" style="background: #F0F9F1; border-color: #C2E7C4;">
                <div class="stat-label">Saldo / Margem Líquida</div>
                <div class="stat-value" style="color: #38B44A;">${totalLiquido.toLocaleString("pt-MZ")} MZN</div>
=======
...
<<<<<<< HEAD
              <div className="flex flex-col sm:flex-row justify-between items-start gap-6 border-b border-slate-800/80 pb-6 print:bg-[#FAF8EB] print:p-6 print:rounded-xl print:border-b-2 print:border-[#283B91] print:text-slate-900 print:mb-6">
=======
...
>>>>>>> 4e5fdc02b24fb0bdfc01f58ecafc0618baa4a82f
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2.5">
<<<<<<< HEAD
                      <span className="text-lg font-black text-white tracking-wider uppercase print:text-[#283B91]">RHINO CARGO LDA</span>
=======
...
>>>>>>> 4e5fdc02b24fb0bdfc01f58ecafc0618baa4a82f
              ...
              <div className="border border-slate-800 rounded-lg overflow-hidden print:border-slate-300">
                <table className="w-full text-left border-collapse text-[10px]">
                  <thead>
<<<<<<< HEAD
                    <tr className="bg-slate-950 text-slate-400 uppercase font-bold text-[9px] border-b border-slate-800 print:bg-[#FAF8EB] print:text-[#283B91] print:border-b-2 print:border-[#283B91]/30">
=======
